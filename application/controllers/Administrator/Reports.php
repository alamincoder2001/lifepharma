...
class Reports extends CI_Controller {
    ...
    public function ExpireList(){
        $data['title'] = "Expire Date Remainder";
        $data['content'] = $this->load->view('Administrator/reports/expire_list', $data, true);
        $this->load->view('Administrator/index', $data);
    }

    function toplowSoldReport(){
        $access = $this->mt->userAccess();
        if(!$access){
            redirect(base_url());
        }
        $data['title'] = "Top & Low Sold Report";
		$data['content'] = $this->load->view('Administrator/reports/top_low_sold', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
