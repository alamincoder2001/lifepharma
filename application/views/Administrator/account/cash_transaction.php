				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group row">
							<label class="col-xs-4 col-sm-4 col-md-4 control-label">Transaction Id</label>
						...
						<div class="form-group row">
							<label class="col-xs-4 col-sm-4 col-md-4 control-label">Transaction Type</label>
					...
					<div class="col-md-5">
						<div class="form-group row">
							<label class="col-xs-4 col-sm-4 col-md-4 control-label">Date</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
						...
						<div class="form-group row">
							<label class="col-xs-4 col-sm-4 col-md-4 control-label">Description</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
						...
						<div class="form-group row">
							<label class="col-xs-4 col-sm-4 col-md-4 control-label">Amount</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
