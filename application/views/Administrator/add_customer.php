	...
	<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
		<div class="col-xs-12 col-sm-12 col-md-5">
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Customer Id:</label>
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Customer Name:</label>
				<div class="col-xs-12 col-sm-12 col-md-7">
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Owner Name:</label>
				<div class="col-xs-12 col-sm-12 col-md-7">
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Address:</label>
				<div class="col-xs-12 col-sm-12 col-md-7">
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Area:</label>
				...
				<div class="col-xs-1 col-sm-1 col-md-1" style="padding:0;margin-left: -15px;"><a href="/area" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
			</div>
		</div>	

		<div class="col-xs-12 col-sm-12 col-md-5">
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Mobile:</label>
				<div class="col-xs-12 col-sm-12 col-md-7">
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-12 col-sm-12 col-md-4">Office Phone:</label>
				<div class="col-xs-12 col-sm-12 col-md-7">
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-8 col-sm-12 col-md-4">Previous Due:</label>
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-8 col-sm-12 col-md-4">Credit Limit:</label>
				<div class="col-xs-8 col-sm-12 col-md-7">
			...
			<div class="form-group clearfix">
				<label class="control-label col-xs-8 col-sm-12 col-md-4">Customer Type:</label>
				<div class="col-xs-8 col-sm-12 col-md-7">
		...
		<div class="col-xs-6 col-md-2 text-center">
			<div class="responsive-img form-group clearfix">
