        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="top_low_sold" v-model="access"> Top & Low Sold Reports</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="purchaseReports">
                    ...
                    <li><input type="checkbox" class="access" value="expire_list" v-model="access"> Expire List</li>
                </ul>
            </div>
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="genetic" v-model="access"> Add Genetic</li>
                    <li><input type="checkbox" class="access" value="company" v-model="access"> Add Company</li>
