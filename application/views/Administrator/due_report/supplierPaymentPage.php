				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Transaction Type</label>
						...
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Payment Type</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
						...
						<div class="form-group" style="display:none;" v-bind:style="{display: payment.SPayment_Paymentby == 'bank' ? '' : 'none'}">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Bank Account</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
						...
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Supplier</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-11 col-sm-11 col-md-6 col-xs-11">
						...
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Due</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
					...
					<div class="col-md-5">
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Payment Date</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
						...
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Description</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
						...
						<div class="form-group">
							<label class="col-xs-5 col-sm-4 col-md-4 control-label">Amount</label>
							<label class="col-xs-1 col-sm-1 col-md-1">:</label>
							<div class="col-xs-12 col-sm-12 col-md-7">
