		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-xs-12 col-sm-12 col-md-4">Supplier Id:</label>
				...
				<div class="form-group clearfix">
					<label class="control-label col-xs-12 col-sm-12 col-md-4">Supplier Name:</label>
					<div class="col-xs-12 col-sm-12 col-md-7">
			...
			<div class="col-md-5">
				<div class="form-group clearfix">
					<label class="control-label col-xs-8 col-sm-12 col-md-4">Mobile:</label>
				...
				<div class="form-group clearfix">
					<label class="control-label col-xs-8 col-sm-12 col-md-4">Email:</label>
					<div class="col-xs-8 col-sm-12 col-md-7">
