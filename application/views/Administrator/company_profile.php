					...
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch">
							...
							<div class="form-group">
								...
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-5">
									<textarea class="form-control" placeholder="Branch Address" rows="6" v-model="branch.address" required></textarea>
								</div>
								<div class="col-sm-3">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr v-for="(branch, sl) in branches">
									...
									<td>
									<img v-if="branch.Brunch_Image == null" class="record_image" src="/assets/no_image.gif">
									<img v-else class="record_image" v-bind:src="'/uploads/brunch/'+branch.Brunch_Image">
									</td>
    ...
    new Vue({
        ...
        methods: {
            ...
            editBranch(branch){
				...
				if(branch.	Brunch_Image == null || branch.Brunch_Image == ''){
					this.imageUrl = null;
				} else {
					this.imageUrl = '/uploads/brunch/'+branch.Brunch_Image;
				}
            },
