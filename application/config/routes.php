...
// genetic
$route['genetic'] = 'Administrator/Page/genetic';
$route['get_genetices'] = 'Administrator/Page/getGenetices';
$route['add_genetic'] = 'Administrator/Page/addGenetic';
$route['update_genetic'] = 'Administrator/Page/updateGenetic';
$route['delete_genetic'] = 'Administrator/Page/deleteGenetic';

// company
$route['company'] = 'Administrator/Page/company';
...
$route['get_available_date']	=	'Administrator/Products/getAvailableExpDate';
$route['get_current_stock']	=	'Administrator/Products/getCurrentStock';
$route['get_total_stock']	=	'Administrator/Products/getTotalStock';
$route['get_expire_stock']	=	'Administrator/Products/getExpireStock';
...
$route['reminder']	=	'Administrator/Reports/ExpireList';
$route['get_expire_list']	=	'Administrator/Products/getPurchaseExpireList';

$route['top_low_sold'] = 'Administrator/Reports/toplowSoldReport'; 
$route['get_top_sold']	=	'Administrator/Products/getTopSold';
